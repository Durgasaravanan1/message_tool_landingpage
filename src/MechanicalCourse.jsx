      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <div id="form" className="relative mt-8 lg:mt-0">
            ...
            <div className="relative bg-white border border-gray-200 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
              <div className="p-6 sm:p-8">
                ...
                {/* FIXED: removed min-h-[420px] to eliminate extra bottom space */}
          ...
          <div className={`bg-white rounded-2xl shadow-2xl border border-emerald-100 px-6 sm:px-8 py-8 text-center w-full max-w-[280px] sm:max-w-[320px] ${popupVisible ? "popup-in" : "popup-out"}`}>
            ...
            <div className="mt-4 h-1 rounded-full bg-gray-100 overflow-hidden">
              <div
                ...
                style={{ width: popupVisible ? "0%" : "100%", transition: popupVisible ? "width 3s linear" : "none" }}
              />
            </div>
          </div>
        </div>
...
function ProgramGlance() {
  return (
    <section className="py-10 sm:py-12 bg-[#f5f7fb]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        <Reveal>
          {/* Top Label */}
          <div className="text-center mb-2">
            <span className="text-emerald-600 text-[10px] sm:text-xs font-semibold tracking-widest uppercase inline-flex items-center gap-1.5">
          ...
          {/* Heading */}
          <h2 className="text-center text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 mb-2">
            Everything included in one program
          </h2>

          {/* Underline */}
          <div className="w-12 h-1 bg-emerald-500 mx-auto rounded-full mb-4"></div>

          {/* Description */}
          <p className="text-center text-gray-500 text-sm sm:text-base mb-8 max-w-xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {PROGRAM_DATA.map((item, i) => {
            ...
            return (
              <div
                key={item.label}
                className="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition duration-300 p-4 sm:p-5"
              >
                {/* Responsive Layout */}
                <div className="flex flex-row sm:flex-col items-start sm:items-center gap-4 sm:gap-3">

                  {/* Icon */}
                  <div className="w-12 h-12 flex-shrink-0 flex items-center justify-center rounded-full bg-emerald-100">
                    <Icon className="w-6 h-6 text-emerald-500 group-hover:scale-110 transition" />
                  </div>

                  {/* Content */}
                  <div className="text-left sm:text-center">
                    
                    {/* Number (optional display, keeps your data) */}
                    <p className="hidden sm:block text-xl sm:text-2xl font-extrabold text-gray-900 mb-1">
                      {item.num}
                    </p>
...
function LearningPath() {
  ...
  return (
  <section className="py-16 bg-gradient-to-r from-emerald-600 to-cyan-600 overflow-hidden text-white">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    
    <Reveal>
      <span className="block text-center text-white/80 text-[10px] sm:text-xs font-semibold tracking-widest uppercase mb-3">
        Learning Path
      </span>

      <h2 className="text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold mb-3">
        Your Road to a Career in Simulation
      </h2>

      <p className="text-center text-white/80 text-sm sm:text-lg mb-12 sm:mb-16 max-w-2xl mx-auto">
    ...
    <div className="relative" ref={lineRef}>
      ...
      {/* Timeline line */}
      <div
        className="hidden lg:block absolute top-12 left-0 h-[2px] w-full bg-white/30"
        style={{
            ...
            <Reveal key={step.step} delay={i * 100}>
              <div className="relative flex flex-col items-center text-center group cursor-default">
                ...
                <div className="relative mb-6 z-10">
                  ...
                  {/* glow */}
                  <div className="absolute inset-0 w-24 h-24 rounded-full bg-white/10 blur-xl"></div>

                  {/* main circle */}
                  <div className="w-20 h-20 rounded-full bg-white/10 border border-white/20 flex items-center justify-center backdrop-blur-md transition-all duration-300 group-hover:scale-110">
                    <Icon className="w-6 h-6 text-white transition-transform duration-300 group-hover:scale-110" />
                  </div>
                </div>

                {/* KEEPING YOUR CONTENT EXACT */}
                <span className="text-white/70 text-[10px] sm:text-xs font-bold mb-1">
                  {step.step}
                </span>

                <span className="text-white font-bold text-sm sm:text-base mb-2">
                  {step.title}
                </span>

                <p className="text-white/80 text-[11px] sm:text-xs leading-relaxed max-w-[160px] sm:max-w-none">
                  {step.desc}
                </p>
  ...
  return (
    <section id="tools" className="py-12 sm:py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Tools */}
        <div className="mb-12">
          <h3 className="text-gray-900 font-bold text-lg mb-6 flex items-center justify-center gap-2 text-center">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 sm:p-8 transition-all duration-300 hover:shadow-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                type="button"
                className="w-full sm:w-auto px-6 py-3 rounded-xl border border-emerald-500 text-emerald-600 font-semibold hover:bg-emerald-50 transition cursor-pointer"
              >
                Talk to Advisor
              </button>
              <button 
                onClick={scrollToForm} 
                type="button"
                className="w-full sm:w-auto px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-500 to-cyan-500 text-white font-semibold hover:opacity-90 transition cursor-pointer"
              >
                View EMI Options
              </button>
            </div>
